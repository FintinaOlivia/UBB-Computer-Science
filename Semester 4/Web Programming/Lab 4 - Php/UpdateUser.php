<?php
require_once(__DIR__ . '/Utils/configuration.php');
global $connection;
$id = "";
$name = "";
$username = "";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./AddUser/AddUser.css">
</head>
...
<div class="container">
    ...
    <form action="./UpdateUser/UpdateUserLogic.php" method="post">
